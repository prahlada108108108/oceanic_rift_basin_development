...
% for spontaneous retreating subduction 
% of visco-elasto-plastic oceanic slab; 
...
for xm = 1:1:mxnum
    for ym = 1:1:mynum
        ...
        if(MX(mm1)>250000 && MX(mm1)<(300000+(18000-MY(mm1))*10) && MY(mm1)>14000 && MY(mm1)<=18000)
            MI(mm1)=3;
        end
