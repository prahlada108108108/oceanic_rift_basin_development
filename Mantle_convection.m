...
% for mantle convection with phase changes; 
% the phase changes are treated based on Gibbs free energy 
% minimization approach with pre-computed 
...
% morn_ro, 
% morn_hh; 
% pre-computed non-steady temperature distribution 
% can be loaded from data file 
% convection.txt; 
...
%     colormap(gray);
    shading interp;
    axis ij image;
    title(['structure, Step=',num2str(ntimestep),' Myr=',num2str(timesum*1e-6/(365.25*24*3600))]); 
    xlabel('x, km')
    ylabel('y, km')
