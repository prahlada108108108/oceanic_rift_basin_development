...
% for oceanic lithosphere extension; 
% the model uses external functions 
...
b=1500; % grid spacing in high resolution area
gridx(31)=750000; % initial position of the area
for i=32:1:131
    gridx(i)=gridx(i-1)+b;
end
...
%    plot(MX1,MY1,'r.');
%    plot(MX1(1:100),MY1(1:100),'r.');
%    plot(MX1(101:200),MY1(101:200),'b.');
%    plot(MX1(201:300),MY1(201:300),'g.');
