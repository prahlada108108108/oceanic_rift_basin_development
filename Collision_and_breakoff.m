...
% for slab breakoff during continental collision; 
% the model accounts for erosion/sedimentation processes 
...
timemax=1e+4*365.25*24*3600; % 10000 year
...
mxnum=1000; %total mber of markers in vertical direction
mxstep=xsize/mxnum; %number of markers in horizontal direction
mynum=300;  %total nu %step between markers in horizontal direction   
...
%     colormap(gray);
    ...
    light;
    lighting phong;
    axis([0 800 0 timesum/(1e+6*365.25*24*3600) -7000 3000]);
    caxis([-10000 3000]);
    axis ij;
    xlabel('distance, km');
    ylabel('time, Myr');
    zlabel('elevation, m');
    title('topography evolution');
